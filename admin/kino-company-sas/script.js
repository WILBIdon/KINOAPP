...
function render(items, containerId, isSearchResult) {
    ...
    container.innerHTML = items.map(item => {
        ...
        let actionButtons = '';
        if (isSearchResult) {
            // Resultados de búsqueda: solo resaltar
            ...
            <div class="border rounded p-4 bg-gray-50">
                <div class="flex justify-between items-start">
                    <div class="flex-grow">
                        ...
                        <a href="../uploads/$kino-company-sas/${item.path}" target="_blank" class="text-indigo-600 underline">
                            Ver PDF Original
                        </a>
                    </div>
...
function downloadCsv() {
    ...
    a.href = url;
    a.download = `documentos_$kino-company-sas_${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
